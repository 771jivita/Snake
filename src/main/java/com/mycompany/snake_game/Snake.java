...
public class Snake extends JFrame implements KeyListener, Runnable {
    ...
    Snake() {
        ...
        //snake has to eat food to grow up
        ...
        p2.add(t);//will contain scoreboard
        //end of ui design
    ...
    public void createbar() {
        ...
        creator.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(p2, "Name" + ":JIVITA SHARMA");
            }
        });
        help.add(creator);
    ...
    public void keyPressed(KeyEvent e) {
        //snake move to left when player pressed left arroe
        ...
        //snake will move ^ when ^key pressed
        ...
        //snake will move right when right key pressed
        ...
        //snake will move down when down key pressed
    ...
    public void run() {
        for (;;) {
            //snake will move forward, in start of game it will move left to right
            //directions will change acc to the key pressed.
